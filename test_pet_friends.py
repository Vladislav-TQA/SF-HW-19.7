...
def test_add_new_pet_with_valid_data(name='Мурзик', animal_type='КОТ',
                                     age='4', pet_photo='images/0101.jpg'):
...
def test_add_new_create_pet_simple_with_valid_data(name='Барон', animal_type='Бульдог',
                                                   age='6'):
...
def test_add_new_pet(name='TTTT', animal_type='$^&&',
                     age='Four', pet_photo='images/0101.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Суперкот", "кот", "3", "images/0101.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_add_new_pet_with_invalid_data(name='ТОМ', animal_type='кот',
                                       age='[4}', pet_photo='images/0102.jpg'):
